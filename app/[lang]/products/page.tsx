...
export default async function ProductsPage({ params }: Props) {
  ...
  const parts = [
    ...
    { part: 'TMS320F28335PGFA', mfg: 'Texas Instruments', desc: 'IC DSP 32BIT 150MHZ 176LQFP', stock: 1500 },
    { part: 'UCC27517AQDBVRQ1', mfg: 'Texas Instruments', desc: 'IC GATE DRIVER LOW-SIDE SOT23', stock: 7715 },
    { part: 'MAX232ACSE+T', mfg: 'Maxim', desc: 'IC TRANSCEIVER RS-232 16SOIC', stock: 12809 },
    { part: 'HFD4/3-S1R', mfg: 'HONGFA', desc: 'RELAY SIGNAL DPDT 2A 3VDC', stock: 46313 },
    { part: 'TPV810S-3STR', mfg: '3PEAK', desc: 'IC SUPERVISOR RESET SOT23', stock: 9000 },
    { part: 'LM7705MMX/NOPB', mfg: 'Texas Instruments', desc: 'IC REG SWITCHED CAP -0.23V MSOP', stock: 10531 },
    { part: 'LM324DR', mfg: 'Texas Instruments', desc: 'IC OPAMP GP 4 CIRCUIT 14SOIC', stock: 8443 },
    { part: 'AD9920ABBCZ', mfg: 'Analog Devices', desc: 'IC CCD SIGNAL PROCESSOR BGA', stock: 1000 },
    { part: 'MDS1521URH', mfg: 'MagnaChip', desc: 'IC MOSFET DRIVER', stock: 13200 },
    { part: 'AD9744ACPZ', mfg: 'Analog Devices', desc: 'IC DAC 14BIT 210MSPS 32LFCSP', stock: 2000 },
    { part: 'LTC5591IUH', mfg: 'Analog Devices', desc: 'IC RF MIXER DOWNCONVERTER QFN', stock: 1500 },
    { part: 'SA612AD/NE612AD', mfg: 'NXP', desc: 'IC MIXER/OSCILLATOR 8SOIC', stock: 5000 },
    { part: 'UDA1342TS', mfg: 'NXP', desc: 'IC AUDIO CODEC STEREO SSOP', stock: 2000 },
    { part: 'ADIS16365BMLZ', mfg: 'Analog Devices', desc: 'IMU 6DOF GYRO/ACCEL MODULE', stock: 500 },
    { part: 'ISL99390', mfg: 'Renesas', desc: 'IC POWER STAGE SMART 90A QFN', stock: 2000 },
    { part: 'TDA21490', mfg: 'Infineon', desc: 'IC POWER STAGE OPTIMOS 60A', stock: 3000 },
    { part: 'TDA21590', mfg: 'Infineon', desc: 'IC POWER STAGE OPTIMOS 70A', stock: 2500 },
    { part: 'L9369-TR', mfg: 'STMicroelectronics', desc: 'IC MULTI-CHANNEL DRIVER AUTO', stock: 1800 },
  ]
